...
resource "aws_apigatewayv2_route" "this" {
  ...
  depends_on = [
    aws_apigatewayv2_api.this, aws_apigatewayv2_integration.this, aws_apigatewayv2_authorizer.this
  ]
}
...
resource "aws_apigatewayv2_integration" "this" {
  ...
  integration_type    = try(each.value.integration_type, try(each.value.lambda_arn, "") != "" ? "AWS_PROXY" : "HTTP_PROXY")
