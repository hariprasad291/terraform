...
output "vpc_secondary_cidr_blocks" {
  ...
  value       = compact(aws_vpc_ipv4_cidr_block_association.cidr_association[*].cidr_block)
}
...
output "igw_id" {
  ...
  value       = try(aws_internet_gateway.internet_gateway[0].id, null)
}

output "igw_arn" {
  description = "The ARN of the Internet Gateway"
  value       = try(aws_internet_gateway.internet_gateway[0].arn, null)
}
...
output "private_ipv6_egress_route_ids" {
  ...
  value       = try(aws_route.private_ipv6_egress[*].id, null)
}
